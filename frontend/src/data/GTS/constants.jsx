export const CIVIL_STATUSES_OPTIONS = [
...
export const EMPLOYMENT_NOW_OPTIONS = [
    "Yes", 
    "No", 
    "Never Employed"
];
...
export const PLACE_OF_WORK_OPTIONS = [
    "Local", 
    "Abroad"
];

export const JOB_FIND_METHODS = [
...
export const JOB_LEVEL_OPTIONS_FIRST = [
  "Rank or Clerical",
...
export const JOB_LEVEL_OPTIONS_CURRENT = [
  "Rank or Clerical",
  "Professional, Technical or Supervisory",
  "Managerial or Executive",
  "Self-employed",
